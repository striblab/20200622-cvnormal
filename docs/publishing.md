...
```html
<div
  data-pym-src="https://static.startribune.com/news/projects/all/20200430-actblue/?pym=true"
>
  Loading...
</div>
<script
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20200430-actblue/",
      "url": "http://static.startribune.com/news/projects-staging/all/20200430-actblue/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20200430-actblue/",
      "url": "http://static.startribune.com/news/projects/all/20200430-actblue/"
    }
  }
}
```
